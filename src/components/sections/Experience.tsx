            ...
            >
              ...
              <div className={`flex flex-col md:flex-row items-center gap-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                <div className="flex-1 w-full">
                  <div className="p-8 rounded-2xl border border-border bg-card shadow-sm hover:border-primary/30 transition-colors">
                ...
                {/* Timeline Dot */}
                <div className="absolute left-0 md:left-1/2 md:-ml-3 w-6 h-6 rounded-full bg-primary border-4 border-background z-10 shadow-lg" />
