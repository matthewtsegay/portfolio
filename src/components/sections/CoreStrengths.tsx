        ...
        {coreStrengths.map((strength, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl border border-border bg-background/80 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10"
            >
